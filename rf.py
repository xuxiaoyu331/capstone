...
df = sqlContext.read.format('com.databricks.spark.csv') \
                   ...
                   .load('/Users/irene/Desktop/project/data/corona_train_clean.csv')
...
word2vec = Word2Vec(vectorSize = 100, minCount = 3, inputCol = 'text_sw_removed', outputCol = 'result')
model = word2vec.fit(df_swr)
df_result = word2vec.transform(df_swr)
...
rf = rf_classifier.fit(train_df)
rf_prediction = rf.transform(test_df)
